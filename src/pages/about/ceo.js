          ...
          <div className="ceo-content">
            <div className="ceo-head-copy">
              <p className="ceo-lead">
                사람과 자연이 공존하는 안전한 환경을 만들기 위해 노력하는 기업 <br/>
            ...
            <div className="ceo-body">
              ...
              <p>
                저희는 산불소화시설 설치 전문 기업으로 사람과 자연의 공존을 최우선 가치로 삼습니다.
              </p>
              <p>
                최고의 기술력이 최고의 안전을 만든다는 믿음으로 오랜 기간 축적된 기술력을 바탕으로 산불 예방 및 초기진화 시스템에 앞장서고 있습니다.
              </p>
              <p>
