...
const rawItems = [
  // 산불방지급수시설
  { date: '2012.08', text: '국립산림과학원 홍릉시험림 산불방지급수시설 설치', tag: '산불소화시설' },
  { date: '2012.09', text: '경남 함양군 국유림관리소 산불방지급수시설 설치', tag: '산불소화시설' },
  { date: '2012.11', text: '경북 봉화군 경제림육성단지 산불방지급수시설 설치', tag: '산불소화시설' },
  { date: '2012.11', text: '경북 울진군 금강송군락지 산불방지급수시설 설치', tag: '산불소화시설' },
  { date: '2013.01', text: '부산 해운대구 재송지구 산불방지급수시설 설치', tag: '산불소화시설' },
  { date: '2013.02', text: '경남 진주시 월아산지구 산불방지급수시설 설치', tag: '산불소화시설' },
  { date: '2013.03', text: '경남 밀양시 대법사지구 산불방지급수시설 설치', tag: '산불소화시설' },

  // 산불진화용 포 소화약제
  { date: '2012.02', text: '산림항공본부 및 각 지역 산림항공 관리소 납품', tag: '산불소화시설' },
  { date: '2013.03', text: '산림항공본부 및 각 지역 산림항공 관리소 납품', tag: '산불소화시설' },
];
